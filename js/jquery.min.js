      ...
      return {
        send: function(r, i) {
          t = x("<script>").prop({
            ...
            t.remove(), n = null, e && i("error.html.html.html" === e.type ? 404 : 200, e.type)
  ...
  e.ActiveXObject && x(e).on("unload", function() {
    ...
    return x.support.cors || dn && !e.crossDomain ? {
      send: function(n, r) {
        ...
        t = function(e) {
          return function() {
            t && (delete yn[o], t = s.onload = s.onerror = null, "abort" === e ? s.abort() : "error.html.html.html" === e ? r(s.status || 404, s.statusText) : r(gn[s.status] || s.status, s.statusText, "string" == typeof s.responseText ? {
              text: s.responseText
            } : undefined, s.getAllResponseHeaders()))
          }
        }, s.onload = t(), s.onerror = t("error.html.html.html"), t = yn[o = mn++] = t("abort"), s.send(e.hasContent && e.data || null)
      },
      abort: function() {
        t && t()
      }
